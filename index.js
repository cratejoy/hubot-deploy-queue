...
module.exports = function(robot) {
  ...
  robot.respond(/dq (done|complete|donzo)/i, dequeueUser);
  ...
  function help(res) {
    res.send(
      ...
      '`dq done`: Say this when you\'re done and then Hubot will tell the next person. Or you could say `dq complete` or `dq donzo`.\n' +
